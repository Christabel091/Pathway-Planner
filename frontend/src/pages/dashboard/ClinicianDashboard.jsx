  ...
  <div className="flex flex-col space-y-6">
    ...
    <nav>
      <ul className="space-y-2">
        {["Dashboard", "Goals", "Inbox", "Medications","Appointment Reminder", "Lab Results", "Account Settings", "Log Out"].map(
          (item) => (
            <li
              key={item}
    ...
    © 2025 Pathway Planner
      ...
      <main className="flex-1 ml-64 p-10 bg-gradient-to-b from-rose-50 via-amber-50 to-emerald-50">
        ...
        <h2 className="text-2xl font-semibold text-emerald-700">
          ...
          Welcome back 
          <p className = "text-emerald-600"> Dr. {displayName}</p>
        </p>
        </h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition flex flex-col items-center justify-center">
          <h3 className="text-lg font-semibold text-emerald-700 mb-4">Patiens Goals Progress</h3>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition">
            ...
            <p className="text-gray-600"> New goals to view </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-rose-100 via-amber-50 to-rose-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition flex flex-col items-start justify-center">
            ...
            <p className="text-gray-700 mb-3"> Mediation Schedule for Patients </p>
          ...
          {/* Next Appointment */}
          <div className="bg-gradient-to-br from-rose-100 via-amber-50 to-rose-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition flex flex-col items-start justify-center">
            <h3 className="text-lg font-semibold text-emerald-800 mb-2"> Next Appoitment</h3>
            <p className="text-gray-700 mb-3"> Send a reminder for the next appointment </p>
            <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg shadow">
              Send a Reminder
            </button>
          </div>
          ...
          <div className="bg-gradient-to-br from-rose-100 via-amber-50 to-rose-200 rounded-2xl shadow-lg p-6 hover:shadow-xl transition flex flex-col items-start justify-center">
            ...
            <p className="text-gray-700 mb-3"> Lab Results can be uploaded here </p>
            <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg shadow">
              Upload Lab Result
            </button>
          </div>
